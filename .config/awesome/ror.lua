...
-- to "class". The "match string" will match substrings. So
-- "Firefox" will match "blah Firefox blah". Use xprop to get this
-- info from a window. WM_CLASS(STRING) gives you "instance",
